...
glm::vec3 Triangle::get_interpolated_normal(glm::vec2 point_coords) const
{
    glm::vec3 normal = normals[0] + (normals[1] - normals[0]) * point_coords.x + (normals[2] - normals[0]) * point_coords.y;
